...
class LoginActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnAccediOspite.setOnClickListener {
            authRepo.accediComeOspite { successo, _ ->
        ...
        binding.tvPasswordDimenticata.setOnClickListener {
            ...
            authRepo.recuperaPassword(email) { successo, eccezione ->
                loadingDialog.nascondiCaricamento()
        ...
        binding.btnLogin.setOnClickListener {
            ...
            loadingDialog.mostraCaricamento()
            authRepo.eseguiLogin(email, password) { successo, errore ->
                loadingDialog.nascondiCaricamento()
                ...
                if (successo) {
                    ...
                    when (errore) {
                        ...
                        is FirebaseNetworkException -> {
                            binding.layoutEmail.error = getString(R.string.error_firebase_no_internet)
                        }
                        else -> {
